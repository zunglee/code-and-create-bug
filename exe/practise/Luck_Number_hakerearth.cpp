...
void cummulativeSumOfPower2(long long unsigned *arr){
    arr[0] = 1;
    for(int i =1 ; i <20;i++){
...
void cummulativeSumOfLuckyNumberTillN(long long unsigned *arr2 , long long unsigned *arr){
    long long unsigned power = 20 ,sum=0;
...
int main()
{
    ...
    long long unsigned arr[100]={0},arr2[20]={0};
    sllu(t);
    cummulativeSumOfPower2(arr);
    cummulativeSumOfLuckyNumberTillN(arr2,arr);
